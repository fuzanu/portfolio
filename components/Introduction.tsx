  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold"> Front-end developer</span> who has been
        learning for <span className="font-bold">1 year</span>. I enjoy building{" "}
        <span className="italic">websites</span>. My focus is{" "}
        <span className="underline font-bold">React</span> (Next.js).
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          href="https://www.linkedin.com/in/cristian-stanciu-9a4b31278/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
